export const capabilities = {
  ...
  endpoints: [
    ...
    { tool: "serphouse_serp_live_get", method: "GET", path: "/serp/live" },
    {
      ...
      method: "POST",
      path: "/serp/google_advanced",
    },
    { tool: "serphouse_google_jobs", method: "POST", path: "/google-jobs-api" },
    {
      tool: "serphouse_google_autocomplete",
      method: "POST",
      path: "/google-autocomplete-api",
    },
    {
      tool: "serphouse_google_videos",
      method: "POST",
      path: "/google-videos-api",
    },
    {
      tool: "serphouse_google_short_videos",
      method: "POST",
      path: "/google-short-videos-api",
    },
    {
      tool: "serphouse_google_forums",
      method: "POST",
      path: "/google-forums-api",
    },
    {
      tool: "serphouse_google_local",
      method: "POST",
      path: "/google-local-api",
    },
  ],
};
...
export const constraints = {
  authentication:
    "Tool inputs do not include authentication fields. Send SERPHOUSE_API: <api_key> on /mcp.",
  location:
    "Location is mandatory for SERP and Google vertical APIs. Provide exactly one of loc or loc_id. Use loc for a human-readable location string or loc_id from serphouse_location_search for precise targeting.",
  advanced_google:
    "Google advanced and Google vertical endpoints only support Google domains and require exactly one of loc or loc_id.",
